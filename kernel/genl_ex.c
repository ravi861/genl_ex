...
static void greet_group(unsigned int group, char *message) {
  void *hdr;
...
#endif
{
  greet_group(GENL_TEST_MCGRP0, "hello");
  greet_group(GENL_TEST_MCGRP1, "hello");
  greet_group(GENL_TEST_MCGRP2, "hello");
...
static const struct genl_multicast_group genl_test_mcgrps[] = {
        [GENL_TEST_MCGRP0] =
            {
             .name = GENL_TEST_MCGRP0_NAME,
            },
        [GENL_TEST_MCGRP1] =
            {
             .name = GENL_TEST_MCGRP1_NAME,
            },
        [GENL_TEST_MCGRP2] =
            {
             .name = GENL_TEST_MCGRP2_NAME,
            },
};
